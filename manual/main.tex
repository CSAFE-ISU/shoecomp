...
\usepackage{hyperref} % for hyperlinks, within and outside the doc
\usepackage{algorithmic} % to explain any algos you might have
\usepackage{listings} % in case you want to drop in some R code
\usepackage{minted} % in case you want to drop in some R code
\usepackage{ifthen}
\usepackage{epsfig}
\usepackage{graphics}
\usepackage{xcolor}
